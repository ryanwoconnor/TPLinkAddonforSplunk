...
class TPLinkApp(admin.MConfigHandler):
    ...
    def handleEdit(self, confInfo):
        ...
        if method == 'post':
            ...
            try:
                sessionKey = self.getSessionKey()
                post_path = '/servicesNS/nobody/TPLinkAddonforSplunk/storage/passwords?output_mode=json'
            ...
            try:
                sessionKey = self.getSessionKey()
                post_path = '/servicesNS/nobody/TPLinkAddonforSplunk/storage/passwords/' + entity
...
admin.init(TPLinkApp, admin.CONTEXT_NONE)
