...
#
#  Modified by Ryan O'Connor, August 14, 2017 to work with Splunk 
#  https://github.com/ryanwoconnor/TPLinkHS110AddonforSplunk
#
#
#############################################################
####THIS SECTION CAN BE MODIFIED FOR YOUR SPECIFIC DEVICE####
ip=192.168.1.225
#############################################################
...
#Standard command for reading energy
cmd=emeter
...
cmd_print_plug_consumption(){
     echo -n $(date)
     echo -n " "
     query_plug "$payload_emeter" | grep "emeter"
